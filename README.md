...
## The Brief
Using Vue 3 and VisitScotland’s component library, display some of your favourite places and attractions in Scotland using a grid of cards or the VisitScotland content swiper component. Each card should have the same layout and information on it and include an option to add the item to a favourites list. <br><br>
